function Shellie(text, heightPos) {
  this.position = createVector(width, heightPos);
  this.text = text;
  this.completedText = "";
  this.focused = false;
  this.intact = true;
  this.animation = ShellieAnimation;
}
Shellie.prototype.draw = function () {
...
Shellie.prototype.update = function () {
...
Shellie.prototype.erode = function (keyCode) {
