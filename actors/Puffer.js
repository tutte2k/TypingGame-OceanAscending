function Puffer(text) {
  this.position = createVector(width, random(100, height - 100));
  this.text = text;
  this.completedText = "";
  this.focused = false;
  this.intact = true;
  this.animation = PufferAnimation;
}
Puffer.prototype.draw = function () {
  ...
  textAlign(CENTER);
  textSize(25);
  text(displayText.toUpperCase(), this.position.x + 5, this.position.y + 40);
};
Puffer.prototype.update = function () {
...
Puffer.prototype.erode = function (keyCode) {
