function Qocto(text) {
  ...
  this.focused = false;
  this.intact = true;
  this.animation = QoctoAnimation;
}
Qocto.prototype.draw = function () {
  ...
  textAlign(CENTER);
  textSize(25);
  text(displayText.toUpperCase(), this.position.x + 10, this.position.y);
};
Qocto.prototype.update = function () {
