function Inker(text) {
  ...
  this.focused = false;
  this.intact = true;
  this.animation = InkerAnimation;
}
Inker.prototype.draw = function () {
  ...
  textAlign(CENTER);
  textSize(25);
  text(displayText.toUpperCase(), this.position.x - 25, this.position.y + 7);
};
Inker.prototype.update = function () {
