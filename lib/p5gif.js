...
function _construct2(e, t, r) {
  return (_construct2 = isNativeReflectConstruct()
    ? Reflect.construct
    : function (e, t, r) {
        var n = [null];
        n.push.apply(n, t);
  ...
  return (function o(s, a, u) {
  ...
  })(
    {
        ...
        function (e, t, r) {
          ...
          (n.prototype.readByte = function () {
            ...
            (n.prototype.readBitArray = function () {
              for (var e = [], t = this.readByte(), r = 7; 0 <= r; r--)
                e.push(!!(t & (1 << r)));
              return e;
            }),
          ...
          (i.prototype.parse = function (e) {
            ...
            (i.prototype.parsePart = function (e, t) {
              ...
              if (!t.requires || t.requires(this.stream, this.output, e))
                if (t.loop) {
                  ...
                  t.parts
                    ? ((r = {}), this.parseParts(r, t.parts), (e[n] = r))
                    : t.parser
                    ? ((r = t.parser(this.stream, this.output, e)),
                      t.skip || (e[n] = r))
                    : t.bits && (e[n] = this.parseBits(t.bits));
            }),
            (i.prototype.parseBits = function (e) {
              ...
              for (var n in e) {
                ...
                i.length
                  ? (t[n] = r
                      .slice(i.index, i.index + i.length)
                      .reduce(function (e, t) {
                        return 2 * e + t;
                      }, 0))
                  : (t[n] = r[i.index]);
        ...
        function (e, t, r) {
          ...
          (n.prototype.decompressFrame = function (e, t) {
            ...
            if (r.image) {
              ...
              r.image.descriptor.lct.interlaced &&
                (i = (function (n, i) {
                  for (
              ...
              return (
                r.image.descriptor.lct && r.image.descriptor.lct.exists
                  ? (o.colorTable = r.image.lct)
                  : (o.colorTable = this.raw.gct),
                r.gce &&
                  ((o.delay = 10 * (r.gce.delay || 10)),
                  (o.disposalType = r.gce.extras.disposal),
                  r.gce.extras.transparentColorGiven &&
                    (o.transparentIndex = r.gce.transparentColorIndex)),
                t &&
                  (o.patch = (function (e) {
                    for (
                      var t = e.pixels.length,
            ...
            (n.prototype.decompressFrames = function (e, t, r) {
              void 0 === t && (t = 0),
                (r =
                  void 0 === r
                    ? this.raw.frames.length
                    : Math.min(r, this.raw.frames.length));
              for (var n = [], i = t; i < r; i++) {
          ...
          var n = {
            ...
            readArray: function (s, a) {
              return function (e, t, r) {
                for (var n = a(e, t, r), i = new Array(n), o = 0; o < n; o++)
                  i[o] = e.readBytes(s);
                return i;
              };
            },
        ...
        function (e, t, r) {
          var n = e("./parsers"),
            i = {
              ...
              parser: function (e) {
                for (
                  var t = [], r = 0, n = e.readByte();
                  0 !== n;
                  n = e.readByte()
                )
                  t.push(e.readBytes(n)), (r += n);
                for (var i = new Uint8Array(r), o = (r = 0); o < t.length; o++)
            ...
            o = {
              ...
              parts: [
                { label: "codes", parser: n.readBytes(2), skip: !0 },
                { label: "byteSize", parser: n.readByte() },
                {
                  label: "extras",
                  bits: {
                ...
                { label: "delay", parser: n.readUnsigned(!0) },
                { label: "transparentColorIndex", parser: n.readByte() },
                { label: "terminator", parser: n.readByte(), skip: !0 },
              ],
            },
            s = {
              label: "image",
              ...
              parts: [
                { label: "code", parser: n.readByte(), skip: !0 },
                {
                  label: "descriptor",
                  parts: [
                    { label: "left", parser: n.readUnsigned(!0) },
                    { label: "top", parser: n.readUnsigned(!0) },
                    { label: "width", parser: n.readUnsigned(!0) },
                    { label: "height", parser: n.readUnsigned(!0) },
                    {
                      label: "lct",
                      bits: {
                        exists: { index: 0 },
                ...
                {
                  label: "data",
                  parts: [{ label: "minCodeSize", parser: n.readByte() }, i],
                },
              ],
            },
            a = {
              ...
              parts: [
                { label: "codes", parser: n.readBytes(2), skip: !0 },
                { label: "blockSize", parser: n.readByte() },
                {
                  label: "preData",
            ...
            c = [
              {
                label: "header",
                parts: [
                  { label: "signature", parser: n.readString(3) },
                  { label: "version", parser: n.readString(3) },
                ],
              },
              {
                label: "lsd",
                parts: [
                  ...
                  { label: "backgroundColorIndex", parser: n.readByte() },
                  { label: "pixelAspectRatio", parser: n.readByte() },
                ],
              },
              {
                label: "gct",
      ...
      6: [
        function (e, t, r) {
          var n = e("./src/Routine"),
            i = e("./src/Timer"),
            o = e("./src/Error");
          t.exports = { Routine: n, Timer: i, Error: o };
        },
        { "./src/Error": 7, "./src/Routine": 8, "./src/Timer": 9 },
      ],
      7: [
        function (e, t, r) {
          var n = (function (e) {
                ...
                ((e =
                  t instanceof Error
                    ? _possibleConstructorReturn2(
                        this,
                        _getPrototypeOf2(n).call(this, t.message)
                      )
                    : _possibleConstructorReturn2(
                        this,
                        _getPrototypeOf2(n).call(this, t)
                      )).msg = t),
                (e.code = r),
                _possibleConstructorReturn2(e)
              );
            }
            return (
              _inherits2(n, _wrapNativeSuper2(Error)),
              _createClass2(
                n,
                [
                  {
          ...
          (n.ERROR = { UNKNOWN: 0, WRONG_TYPE: 1, TIMEOUT: 100 }),
            (t.exports = n);
        },
        {},
      ],
      8: [
        function (e, t, r) {
                ...
                _createClass2(v, null, [
                  {
                    ...
                    value: function (n) {
                      ...
                      (n && "function" == typeof n) ||
                        w.Raise(
                          "Only function is accepted to create a routine.",
                          w.ERROR.WRONG_TYPE
                        ),
                        (i = Object.assign(v.DEFAULT_CONF, i));
                      var o = 0,
                        e = 0,
                        t = 0,
                        s = i.tickIntv,
                                  ...
                                  for (;;)
                                    switch ((e.prev = e.next)) {
                                      ...
                                      case 4:
                                        return (
                                          (e.next = 6),
                                          x(s || Math.max(10, i.tickIntv))
                                        );
                                      case 6:
                                        i.infinite ||
                                          a !== v.ROUTINE_STATE.START ||
                                          (a = v.ROUTINE_STATE.STOP),
                                          (e.next = 0);
                                        break;
                                      case 9:
                                      case "end":
                      ...
                      var p = function () {
                          return (
                            (a = v.ROUTINE_STATE.START), (e = Date.now()), u
                          );
                        },
                        d = function () {
                        ...
                        g = function () {
                          return (
                            (a = v.ROUTINE_STATE.PAUSE), (t = Date.now() - e), u
                          );
                        },
                        m = function () {
                          return (
                        ...
                        b = function (e) {
                          return function () {
                            if (a === v.ROUTINE_STATE.TERMINATED)
                              throw new w(
                                "Cannot operate on a terminated routine.",
                                0
                              );
                      ...
                      return (u = {
                        ...
                        get lasts() {
                          return a === v.ROUTINE_STATE.START
                            ? Date.now() - e + t
                            : t;
                        },
                        get tick() {
                  ...
                  },
                  {
                    ...
                    value: function (s) {
                      ...
                      (s && "function" == typeof s) ||
                        w.Raise(
                          "Only function is accepted to create a task.",
                          w.ERROR.WRONG_TYPE
                        ),
                        (u = parseInt(u, 10) || 0) < 0 && (u = 0);
                      var c = !1;
                      return function () {
                        for (
          ...
          (n.ROUTINE_STATE = {
            ...
            (n.BASE_WAIT = 10),
            (n.DEFAULT_CONF = { tickIntv: 10, timeout: 0, infinite: !1 }),
            (t.exports = n);
        },
        { "./Error.js": 7, "./Timer.js": 9 },
      ],
      9: [
        function (e, t, r) {
          e("./Error.js");
        ...
        function (w, x, e) {
          (function (t) {
            ...
            function g(e, t, r, n) {
              ...
              if (f.isDate(e) && f.isDate(t))
                return e.getTime() === t.getTime();
              if (f.isRegExp(e) && f.isRegExp(t))
                return (
                  e.source === t.source &&
                  e.global === t.global &&
              ...
              if (
                (null !== e && "object" === _typeof2(e)) ||
                (null !== t && "object" === _typeof2(t))
              ) {
                if (
                  u(e) &&
                  u(t) &&
            ...
            (c.AssertionError = function (e) {
              ...
              f.inherits(c.AssertionError, Error),
              (c.fail = _),
              (c.ok = e),
      ...
      13: [
          ...
          (function (n, i) {
            ...
            function u(e, t) {
              ...
              return (
                ...
                m(t) ? (r.showHidden = t) : t && T._extend(r, t),
            ...
            function p(t, r, n) {
              ...
              return (
                x(r) && (f = " " + RegExp.prototype.toString.call(r)),
                      ...
                      (c = l
                        ? (function (t, r, n, i, e) {
                            for (var o = [], s = 0, a = r.length; s < a; ++s)
                              E(r, String(s))
                                ? o.push(_(t, r, n, i, String(s), !0))
                                : o.push("");
                            return (
                              e.forEach(function (e) {
                                e.match(/^\d+$/) ||
                                  o.push(_(t, r, n, i, e, !0));
                              }),
                              o
                            );
                          })(t, r, n, a, s)
        ...
        { "./support/isBuffer": 12, _process: 360, inherits: 11 },
      ],
      14: [
        function (r, e, t) {
          (function (e) {
          ...
          (r.byteLength = function (e) {
            ...
            (r.toByteArray = function (e) {
              for (
                ...
                (t =
                  (l[e.charCodeAt(u)] << 18) |
                  (l[e.charCodeAt(u + 1)] << 12) |
                  (l[e.charCodeAt(u + 2)] << 6) |
                  l[e.charCodeAt(u + 3)]),
                  (o[s++] = (t >> 16) & 255),
                  (o[s++] = (t >> 8) & 255),
                  (o[s++] = 255 & t);
              ...
              2 === i &&
                ((t =
                  (l[e.charCodeAt(u)] << 2) | (l[e.charCodeAt(u + 1)] >> 4)),
                (o[s++] = 255 & t));
              1 === i &&
                ((t =
                  (l[e.charCodeAt(u)] << 10) |
                  (l[e.charCodeAt(u + 1)] << 4) |
                  (l[e.charCodeAt(u + 2)] >> 2)),
                (o[s++] = (t >> 8) & 255),
                (o[s++] = 255 & t));
              return o;
            }),
        ...
        function (e, t, r) {
          ...
          function a(e, t, r) {
            ...
            var i = (function (e) {
              ...
              if (void 0 !== e.length)
                return "number" != typeof e.length || N(e.length) ? s(0) : f(e);
          ...
          (r.kMaxLength = i),
            ...
            (l.concat = function (e, t) {
              ...
              for (r = 0; r < e.length; ++r) {
                var o = e[r];
                if ((B(o, Uint8Array) && (o = l.from(o)), !l.isBuffer(o)))
                  throw new TypeError(
                    '"list" argument must be an Array of Buffers'
                  );
            ...
            (l.prototype.write = function (e, t, r, n) {
              ...
              for (var o, s, a, u, c, f, l, h, p, d = !1; ; )
                switch (n) {
                  ...
                  case "utf-8":
                    return (
                      (h = t), (p = r), L(I(e, (l = this).length - h), l, h, p)
                    );
                  case "ascii":
                    return y(this, e, t, r);
                  case "latin1":
          ...
          function C(e) {
            return n.toByteArray(
              (function (e) {
                if (
                  (e = (e = e.split("=")[0]).trim().replace(A, "")).length < 2
                )
                  return "";
                for (; e.length % 4 != 0; ) e += "=";
                return e;
      ...
      18: [
        ...
        { "../../modules/_core": 39, "../../modules/core.regexp.escape": 144 },
      ],
      19: [
        function (e, t, r) {
          t.exports = function (e) {
          ...
          t.exports =
            ...
            function (e, t) {
              var r = c(this),
                ...
                u = 1;
              for (
                o < i && i < o + a && ((u = -1), (o += a - 1), (i += a - 1));
                0 < a--;

              )
                o in r ? (r[i] = r[o]) : delete r[i], (i += u), (o += u);
              return r;
            };
        },
        {
      ...
      30: [
        ...
        { "./_is-array": 65, "./_is-object": 67, "./_wks": 142 },
      ],
      31: [
        function (e, t, r) {
      ...
      32: [
        ...
        { "./_a-function": 19, "./_invoke": 62, "./_is-object": 67 },
      ],
      33: [
        function (e, t, r) {
          var i = e("./_cof"),
          ...
          t.exports = {
            getConstructor: function (e, o, r, n) {
              ...
              return (
                u(i.prototype, {
                  clear: function () {
                    for (var e = d(this, o), t = e._i, r = e._f; r; r = r.n)
              ...
              n(
                ...
                function () {
                  ...
                  return e._t && (e._l = r = r ? r.n : e._t._f)
                    ? i(0, "keys" == t ? r.k : "values" == t ? r.v : [r.k, r.v])
                    : ((e._t = void 0), i(1));
                },
                t ? "entries" : "values",
                !t,
      ...
      36: [
        ...
        { "./_array-from-iterable": 26, "./_classof": 33 },
      ],
      37: [
        function (e, t, r) {
      ...
      40: [
        ...
        { "./_object-dp": 87, "./_property-desc": 105 },
      ],
      41: [
        function (e, t, r) {
          var o = e("./_a-function");
      ...
      43: [
        ...
        { "./_an-object": 23, "./_to-primitive": 133 },
      ],
      44: [
        function (e, t, r) {
          t.exports = function (e) {
        ...
        function (e, t, r) {
          ...
          t.exports = function (e) {
            var t = a(e),
              r = u.f;
            if (r)
              for (var n, i = r(e), o = c.f, s = 0; i.length > s; )
                o.call(e, (n = i[s++])) && t.push(n);
            return t;
          };
        },
        { "./_object-gops": 93, "./_object-keys": 96, "./_object-pie": 97 },
      ],
      49: [
        function (e, t, r) {
          var _ = e("./_global"),
            ...
            for (var c, f, l = o, h = 0, p = !!a && m(a, u, 3); h < i; ) {
              if (h in n) {
                if (
                  ((c = p ? p(n[h], h, r) : n[h]),
                  (f = !1),
                  _(c) && (f = void 0 !== (f = c[y]) ? !!f : d(c)),
                  f && 0 < s)
                )
                  l = e(t, r, c, g(c.length), l, s - 1) - 1;
                else {
      ...
      58: [
        ...
        { "./_descriptors": 45, "./_object-dp": 87, "./_property-desc": 105 },
      ],
      59: [
        function (e, t, r) {
      ...
      60: [
        ...
        { "./_descriptors": 45, "./_dom-create": 46, "./_fails": 51 },
      ],
      61: [
        function (e, t, r) {
          var o = e("./_is-object"),
      ...
      68: [
        ...
        { "./_cof": 34, "./_is-object": 67, "./_wks": 142 },
      ],
      69: [
        function (e, t, r) {
          var o = e("./_an-object");
      ...
      71: [
        function (e, t, r) {
          ...
          t.exports = function (e, t, r, n, i, o, s) {
            ...
            if (
              (y &&
                (c = E(y.call(new e()))) !== Object.prototype &&
                c.next &&
                (k(c, l, !0), b || "function" == typeof c[T] || x(c, T, M)),
              h &&
                _ &&
                _.name !== R &&
                ((p = !0),
        ...
        function (e, t, r) {
          ...
          t.exports =
            ...
            e("./_fails")(function () {
              ...
              ? function (e, t) {
                  for (
                    var r = _(e), n = arguments.length, i = 1, o = p.f, s = d.f;
                    i < n;
        ...
        function (n, e, t) {
          ...
          e.exports =
            ...
            function (e, t) {
              ...
              return (
                null !== e
                  ? ((u[c] = i(e)), (r = new u()), (u[c] = null), (r[a] = e))
                  : (r = f()),
                void 0 === t ? r : o(r, t)
              );
            };
      ...
      88: [
        function (e, t, r) {
          ...
          t.exports = e("./_descriptors")
            ...
            : function (e, t) {
                a(e);
                for (var r, n = u(t), i = n.length, o = 0; o < i; )
                  s.f(e, (r = n[o++]), t[r]);
                return e;
              };
        },
      ...
      89: [
        ...
        { "./_fails": 51, "./_global": 56, "./_library": 75 },
      ],
      90: [
        function (e, t, r) {
          var n = e("./_object-pie"),
      ...
      91: [
        ...
        { "./_object-gopn": 92, "./_to-iobject": 130 },
      ],
      92: [
        function (e, t, r) {
        ...
        { "./_enum-bug-keys": 47, "./_object-keys-internal": 95 },
      ],
      93: [
        function (e, t, r) {
      ...
      94: [
        ...
        { "./_has": 57, "./_shared-key": 115, "./_to-object": 132 },
      ],
      95: [
        function (e, t, r) {
          var s = e("./_has"),
      ...
      99: [
        function (e, t, r) {
          ...
          t.exports = function (a) {
            return function (e) {
              for (
                var t, r = c(e), n = u(r), i = n.length, o = 0, s = [];
                o < i;

              )
                f.call(r, (t = n[o++])) && s.push(a ? [t, r[t]] : r[t]);
              return s;
            };
          };
        },
        { "./_object-keys": 96, "./_object-pie": 97, "./_to-iobject": 130 },
      ],
      100: [
        function (e, t, r) {
      ...
      101: [
        ...
        { "./_global": 56, "./_string-trim": 124, "./_string-ws": 125 },
      ],
      102: [
        function (e, t, r) {
      ...
      110: [
        ...
        { "./_a-function": 19, "./_ctx": 41, "./_export": 49, "./_for-of": 55 },
      ],
      111: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      114: [
        ...
        { "./_has": 57, "./_object-dp": 87, "./_wks": 142 },
      ],
      115: [
        function (e, t, r) {
      ...
      116: [
        ...
        { "./_core": 39, "./_global": 56, "./_library": 75 },
      ],
      117: [
        function (e, t, r) {
          var i = e("./_an-object"),
        ...
        { "./_a-function": 19, "./_an-object": 23, "./_wks": 142 },
      ],
      118: [
        function (e, t, r) {
          var n = e("./_fails");
      ...
      121: [
        ...
        { "./_defined": 44, "./_export": 49, "./_fails": 51 },
      ],
      122: [
        function (e, t, r) {
          var f = e("./_to-length"),
        ...
        { "./_defined": 44, "./_string-repeat": 123, "./_to-length": 131 },
      ],
      123: [
        function (e, t, r) {
          var i = e("./_to-integer"),
      ...
      128: [
        ...
        { "./_to-integer": 129, "./_to-length": 131 },
      ],
      129: [
        function (e, t, r) {
          var n = Math.ceil,
        ...
        function (e, t, r) {
          if (e("./_descriptors")) {
            var m = e("./_library"),
              ...
              Ie = function (e, t) {
                for (var r = 0, n = t.length, i = Ae(e, n); r < n; )
                  i[r] = t[r++];
                return i;
              },
              Ce = function (e, t, r) {
              ...
              Le = function (e) {
                var t,
                  ...
                  l = _(a);
                if (null != l && !d(l)) {
                  for (s = l.call(a), n = [], t = 0; !(o = s.next()).done; t++)
                    n.push(o.value);
                  a = n;
                }
                for (
                  f && 2 < u && (c = h(c, arguments[2], 2)),
                    t = 0,
                    r = S(a.length),
                    i = Ae(this, r);
                  t < r;
              ...
              Ve = function (e, t, r) {
                return !(ze(e, (t = u(t, !0))) && T(r) && c(r, "value")) ||
                  c(r, "get") ||
                  c(r, "set") ||
                  r.configurable ||
            ...
            o(He, Ge),
              ...
              (t.exports = function (e, l, t, o) {
                ...
                i
                  ? ((p = t(function (e, t, r, n) {
                      ...
                      var i,
                        ...
                        c = 0;
                      if (T(t)) {
                        if (!(t instanceof X || (a = E(t)) == H || a == Y))
                          return je in t ? Ie(p, t) : Le.call(p, t);
                        (i = t), (c = Re(r, l));
                        var f = t.byteLength;
                        if (void 0 === n) {
                          if (f % l) throw z(ke);
                      ...
                      for (
                        j(e, "_d", { b: i, o: c, l: o, e: s, v: new Z(i) });
                        u < s;
                  ...
                  : (b(function () {
                    ...
                    Q(
                      n !== Function.prototype ? M(a).concat(M(n)) : M(a),
                      function (e) {
                        e in p || j(p, e, a[e]);
                      }
                    ),
                ...
                j(p, ve, !0),
                  ...
                  v(v.P, h, Ue),
                  B(h),
                  v(v.P + v.F * Oe, h, { set: We }),
                  v(v.P + v.F * !_, h, Ge),
                  m || c.toString == ge || (c.toString = ge),
                  v(
                    v.P +
                      v.F *
                        b(function () {
      ...
      135: [
        function (e, t, r) {
          ...
          function F(e, t, r) {
            ...
            for (
              (e = O(e)) != e || e === E
                ...
                : ((n = M(A(e) / P)),
                  e * (o = R(2, -n)) < 1 && (n--, (o *= 2)),
                  2 <= (e += 1 <= n + c ? f / o : f * R(2, 1 - c)) * o &&
                    (n++, (o /= 2)),
                  u <= n + c
                    ? ((i = 0), (n = u))
                    : 1 <= n + c
                    ? ((i = (e * o - 1) * R(2, t)), (n += c))
                    : ((i = e * R(2, c - 1) * R(2, t)), (n = 0)));
              8 <= t;
              s[l++] = 255 & i, i /= 256, t -= 8
            );
            for (
          ...
          function J(e, t, r, n, i, o) {
            ...
            for (var a = e[L]._b, u = s + e[N], c = n(+i), f = 0; f < t; f++)
              a[u + f] = c[o ? f : t - f - 1];
          }
          if (s.ABV) {
            if (
      ...
      142: [
        ...
        { "./_global": 56, "./_shared": 116, "./_uid": 137 },
      ],
      143: [
        function (e, t, r) {
          var n = e("./_classof"),
        ...
        { "./_classof": 33, "./_core": 39, "./_iterators": 74, "./_wks": 142 },
      ],
      144: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      146: [
        ...
        { "./_array-methods": 28, "./_export": 49, "./_strict-method": 118 },
      ],
      147: [
        function (e, t, r) {
          var n = e("./_export");
        ...
        { "./_add-to-unscopables": 21, "./_array-fill": 25, "./_export": 49 },
      ],
      148: [
        function (e, t, r) {
          var n = e("./_export"),
            ...
            "Array",
            {
              from: function (e) {
                var t,
                  ...
                  l = y(o);
                if (
                  (c && (u = h(u, 2 < a ? arguments[2] : void 0, 2)),
                  null == l || (s == Array && _(l)))
                )
                  for (r = new s((t = g(o.length))); f < t; f++)
                    m(r, f, c ? u(o[f], f) : o[f]);
                else
                  for (i = l.call(o), r = new s(); !(n = i.next()).done; f++)
                    m(r, f, c ? d(i, u, [n.value, f], !0) : n.value);
                return (r.length = f), r;
              },
            }
          );
          ...
          n(n.P + n.F * (s || !e("./_strict-method")(o)), "Array", {
            indexOf: function (e) {
              return s
                ...
                : i(this, e, arguments[1]);
            },
          });
        },
        { "./_array-includes": 27, "./_export": 49, "./_strict-method": 118 },
      ],
      154: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      156: [
        function (e, t, r) {
          ...
          n(
            n.P +
              n.F * (e("./_iobject") != Object || !e("./_strict-method")(o)),
            "Array",
            {
              join: function (e) {
          ...
          n(n.P + n.F * (u || !e("./_strict-method")(a)), "Array", {
            lastIndexOf: function (e) {
              ...
              var t = i(this),
                ...
                n = r - 1;
              for (
                1 < arguments.length && (n = Math.min(n, o(arguments[1]))),
                  n < 0 && (n = r + n);
                0 <= n;
                n--
              )
      ...
      159: [
        ...
        { "./_create-property": 40, "./_export": 49, "./_fails": 51 },
      ],
      160: [
        function (e, t, r) {
          var n = e("./_export"),
        ...
        { "./_array-reduce": 29, "./_export": 49, "./_strict-method": 118 },
      ],
      161: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      167: [
        ...
        { "./_date-to-iso-string": 42, "./_export": 49 },
      ],
      168: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      169: [
        ...
        { "./_date-to-primitive": 43, "./_hide": 58, "./_wks": 142 },
      ],
      170: [
        function (e, t, r) {
      ...
      183: [
        function (e, t, r) {
          ...
          n(n.S, "Math", {
            hypot: function (e, t) {
              for (var r, n, i = 0, o = 0, s = arguments.length, a = 0; o < s; )
                a < (r = u(arguments[o++]))
                  ? ((i = i * (n = a / r) * n + 1), (a = r))
                  : (i += 0 < r ? (n = r / a) * n : r);
      ...
      189: [
        ...
        { "./_export": 49, "./_fails": 51, "./_math-expm1": 76 },
      ],
      190: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      202: [
        function (e, t, r) {
          var n = e("./_export"),
            ...
            p = function (e, t) {
              for (var r = -1, n = t; ++r < 6; )
                (n += e * s[r]), (s[r] = n % 1e7), (n = o(n / 1e7));
            },
            d = function (e) {
              for (var t = 6, r = 0; 0 <= --t; )
                (r += s[t]), (s[t] = o(r / e)), (r = (r % e) * 1e7);
            },
            _ = function () {
              for (var e = 6, t = ""; 0 <= --e; )
                if ("" !== t || 0 === e || 0 !== s[e]) {
      ...
      203: [
        ...
        { "./_a-number-value": 20, "./_export": 49, "./_fails": 51 },
      ],
      204: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      206: [
        ...
        { "./_descriptors": 45, "./_export": 49, "./_object-dps": 88 },
      ],
      207: [
        function (e, t, r) {
          var n = e("./_export");
        ...
        { "./_descriptors": 45, "./_export": 49, "./_object-dp": 87 },
      ],
      208: [
        function (e, t, r) {
          var n = e("./_is-object"),
        ...
        { "./_is-object": 67, "./_meta": 81, "./_object-sap": 98 },
      ],
      209: [
        function (e, t, r) {
          var n = e("./_to-iobject"),
        ...
        { "./_object-gopd": 90, "./_object-sap": 98, "./_to-iobject": 130 },
      ],
      210: [
        function (e, t, r) {
        ...
        { "./_object-gopn-ext": 91, "./_object-sap": 98 },
      ],
      211: [
        function (e, t, r) {
          var n = e("./_to-object"),
        ...
        { "./_object-gpo": 94, "./_object-sap": 98, "./_to-object": 132 },
      ],
      212: [
        function (e, t, r) {
          var n = e("./_is-object");
      ...
      216: [
        ...
        { "./_object-keys": 96, "./_object-sap": 98, "./_to-object": 132 },
      ],
      217: [
        function (e, t, r) {
          var n = e("./_is-object"),
      ...
      220: [
        ...
        { "./_classof": 33, "./_redefine": 107, "./_wks": 142 },
      ],
      221: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      227: [
        ...
        { "./_an-object": 23, "./_export": 49, "./_object-gopd": 90 },
      ],
      228: [
        function (e, t, r) {
          var n = e("./_export"),
        ...
        { "./_an-object": 23, "./_export": 49, "./_iter-create": 70 },
      ],
      229: [
        function (e, t, r) {
      ...
      230: [
        ...
        { "./_an-object": 23, "./_export": 49, "./_object-gpo": 94 },
      ],
      231: [
        function (e, t, r) {
          ...
          if (
            ...
            c = function (e, t) {
              var r = this instanceof c,
                n = a(e),
                i = void 0 === t;
              return !r && n && e.constructor === c && i
                ? e
                : o(
                    d
                      ? new f(n && !i ? e.source : e, t)
                      : f(
      ...
      239: [
        ...
        { "./_descriptors": 45, "./_flags": 53, "./_object-dp": 87 },
      ],
      240: [
        function (e, t, r) {
          ...
          t("./_fix-re-wks")("split", 2, function (i, o, s) {
            ...
            if (
              ...
              s = function (e, t) {
                ...
                for (
                  m || (n = new RegExp("^" + h.source + "$(?!\\s)", c));
                  (i = h.exec(r)) &&
                  !(
                    f < (o = i.index + i[0][g]) &&
                    (u.push(r.slice(f, i.index)),
                    !m &&
                      1 < i[g] &&
                      i[0].replace(n, function () {
                        for (a = 1; a < arguments[g] - 2; a++)
                          void 0 === arguments[a] && (i[a] = void 0);
                      }),
                    1 < i[g] && i.index < r[g] && _.apply(u, i.slice(1)),
                    (s = i[0][g]),
                    (f = o),
                    u[g] >= l)
                  );
      ...
      255: [
        ...
        { "./_export": 49, "./_to-absolute-index": 127 },
      ],
      256: [
        function (e, t, r) {
          var n = e("./_export"),
        ...
        { "./_export": 49, "./_fails-is-regexp": 50, "./_string-context": 120 },
      ],
      257: [
        function (e, t, r) {
      ...
      258: [
        ...
        { "./_iter-define": 71, "./_string-at": 119 },
      ],
      259: [
        function (e, t, r) {
          ...
          n(n.S, "String", {
            raw: function (e) {
              for (
                ...
                i.push(String(t[o++])), o < n && i.push(String(arguments[o]));
              return i.join("");
            },
          });
        },
        { "./_export": 49, "./_to-iobject": 130, "./_to-length": 131 },
      ],
      261: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      268: [
        function (e, t, r) {
          var n = e("./_global"),
            ...
            K = function (e, t) {
              y(e);
              for (var r, n = g((t = v(t))), i = 0, o = n.length; i < o; )
                J(e, (r = n[i++]), t[r]);
              return e;
            },
            $ = function (e) {
            ...
            X = function (e, t) {
              if (
                ((e = v(e)), (t = w(t, !0)), e !== W || !s(U, t) || s(D, t))
              ) {
                var r = O(e, t);
                return (
                  !r || !s(U, t) || (s(e, L) && e[L][t]) || (r.enumerable = !0),
                  r
                );
              }
            },
            Z = function (e) {
              for (var t, r = M(v(e)), n = [], i = 0; r.length > i; )
                s(U, (t = r[i++])) || t == L || t == u || n.push(t);
              return n;
            },
            Q = function (e) {
              for (
                var t, r = e === W, n = M(r ? D : v(e)), i = [], o = 0;
                n.length > o;

              )
                !s(U, (t = n[o++])) || (r && !s(W, t)) || i.push(U[t]);
              return i;
            };
          G ||
            (a(
                ...
                return (
                  i &&
                    ...
                    V(W, r, {
                      ...
                      set: function e(t) {
                        this === W && e.call(D, t),
                          s(this, L) && s(this[L], r) && (this[L][r] = !1),
                          V(this, r, x(1, t));
                      },
                    }),
                  H(r)
            ...
            (k.f = X),
            (E.f = J),
            (e("./_object-gopn").f = S.f = Z),
            (e("./_object-pie").f = $),
            (e("./_object-gops").f = Q),
            i && !e("./_library") && a(W, "propertyIsEnumerable", $, !0),
            (d.f = function (e) {
              return H(p(e));
            })),
            o(o.G + o.W + o.F * !G, { Symbol: A });
          for (
            var ee =
          ...
          o(o.S + o.F * !G, "Symbol", {
            ...
            A[C][B] || e("./_hide")(A[C], B, A[C].valueOf),
            l(A, "Symbol"),
            l(Math, "Math", !0),
            l(n.JSON, "JSON", !0);
        },
      ...
      270: [
        ...
        { "./_export": 49, "./_typed": 136, "./_typed-buffer": 135 },
      ],
      271: [
        function (e, t, r) {
      ...
      280: [
        function (e, t, r) {
          ...
          f(function () {
            ...
            (a((o = u.getConstructor(m, h)).prototype, y),
            (i.NEED = !0),
      ...
      285: [
        ...
        { "./_cof": 34, "./_export": 49, "./_global": 56, "./_microtask": 83 },
      ],
      286: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      290: [
        function (e, t, r) {
          var n = e("./_export");
          n(n.P + n.R, "Map", { toJSON: e("./_collection-to-json")("Map") });
        },
        { "./_collection-to-json": 36, "./_export": 49 },
      ],
      291: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      294: [
        ...
        { "./_export": 49, "./_math-fround": 77, "./_math-scale": 79 },
      ],
      295: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      300: [
        function (e, t, r) {
          var n = e("./_export");
          n(n.S, "Math", { scale: e("./_math-scale") });
        },
        { "./_export": 49, "./_math-scale": 79 },
      ],
      301: [
        function (e, t, r) {
          var n = e("./_export");
      ...
      303: [
        function (e, t, r) {
          var n = e("./_export"),
            ...
            s = e("./_object-dp");
          e("./_descriptors") &&
            n(n.P + e("./_object-forced-pam"), "Object", {
      ...
      305: [
        ...
        { "./_export": 49, "./_object-to-array": 99 },
      ],
      306: [
        function (e, t, r) {
          var n = e("./_export"),
          ...
          n(n.S, "Object", {
            getOwnPropertyDescriptors: function (e) {
              for (
                var t, r, n = c(e), i = f.f, o = u(n), s = {}, a = 0;
                o.length > a;

              )
                void 0 !== (r = i(n, (t = o[a++]))) && l(s, t, r);
              return s;
            },
          });
        },
      ...
      312: [
        ...
        { "./_export": 49, "./_new-promise-capability": 84, "./_perform": 103 },
      ],
      313: [
        function (e, t, r) {
          var n = e("./_metadata"),
      ...
      316: [
        ...
        { "./_an-object": 23, "./_metadata": 82, "./_object-gpo": 94 },
      ],
      317: [
        function (e, t, r) {
          var n = e("./_metadata"),
      ...
      321: [
        ...
        { "./_a-function": 19, "./_an-object": 23, "./_metadata": 82 },
      ],
      322: [
        function (e, t, r) {
      ...
      324: [
        function (e, t, r) {
          var n = e("./_export");
          n(n.P + n.R, "Set", { toJSON: e("./_collection-to-json")("Set") });
        },
        { "./_collection-to-json": 36, "./_export": 49 },
      ],
      325: [
      ...
      327: [
        ...
        { "./_export": 49, "./_string-pad": 122, "./_user-agent": 138 },
      ],
      328: [
        function (e, t, r) {
          var n = e("./_export"),
      ...
      340: [
        ...
        { "./_export": 49, "./_global": 56, "./_user-agent": 138 },
      ],
      341: [
        function (e, t, r) {
        ...
        function (o, c, e) {
          (function (r) {
            ...
            function i(e, t, r) {
              ...
              s.call(this, { highWaterMark: n || 0 === n ? n : 65536 }),
                (this.width = ~~e),
                (this.height = ~~t),
              ...
              this.on("writeHeader#stop", o),
                this.on("frame#stop", o),
                this.on("finish#stop", function () {
                  o(), i.push(null);
                });
            }
            e.inherits(s, t),
              ...
              (s.prototype.writeUTFBytes = function (e) {
                for (var t = e.length, r = 0; r < t; r++)
                  this.writeByte(e.charCodeAt(r));
              }),
              (s.prototype.writeBytes = function (e, t, r) {
                for (var n = r || e.length, i = t || 0; i < n; i++)
                  this.writeByte(e[i]);
              }),
              e.inherits(i, s),
              ...
              (i.prototype.analyzeImage = function (e, t) {
                t &&
                  ...
                  t && !0 === t.indexedPixels
                    ? (a(
                        t.palette,
                        "`options.indexedPixels` requires `options.palette` to load from. Please include one`"
                      ),
                      this.setImagePixels(e))
                    : this.setImagePixels(this.removeAlphaChannel(e)),
                  this.analyzePixels(t),
                  t && t.palette && (this.userPalette = null);
              }),
              ...
              (i.prototype.analyzePixels = function (e) {
                ...
                if (null !== this.userPalette) {
                  a(
                    e && !0 === e.indexedPixels,
                    "`palette` can only be used with `options.indexedPixels` at the moment. Please add `{indexedPixels: true}` to `addFrame()`"
                  ),
                    (t = this.pixels.length),
                  ...
                  (t = this.pixels.length / 3),
                    (this.indexedPixels = new Uint8Array(t)),
                    (n = new u(this.pixels, this.sample)).buildColormap(),
                    (this.colorTab = n.getColormap());
                  for (var o = 0, s = 0; s < t; s++)
                    (r = n.lookupRGB(
                      ...
                      (this.usedEntry[r] = !0),
                      (this.indexedPixels[s] = r);
                }
                (this.pixels = null),
                  (this.colorDepth = 8),
                  (this.palSize = 7),
                  null !== this.transparent
                    ? (this.transIndex = n.lookupRGB(
                        (16711680 & this.transparent) >> 16,
                        (65280 & this.transparent) >> 8,
                        255 & this.transparent
                      ))
                    : (this.transIndex = 0);
              }),
              ...
              (i.prototype.writeGraphicCtrlExt = function () {
                ...
                this.writeByte(33),
                  this.writeByte(249),
                  this.writeByte(4),
                  (t = null === this.transparent ? (e = 0) : ((e = 1), 2)),
                  0 <= this.dispose && (t = 7 & this.dispose),
                  (t <<= 2),
                  this.writeByte(0 | t | e),
              ...
              (i.prototype.writeImageDesc = function () {
                this.writeByte(44),
                  ...
                  this.firstFrame
                    ? this.writeByte(0)
                    : this.writeByte(128 | this.palSize);
              }),
              (i.prototype.writeLSD = function () {
                this.writeShort(this.width),
                  this.writeShort(this.height),
                  this.writeByte(240 | this.palSize),
                  this.writeByte(0),
                  this.writeByte(0);
              }),
      ...
      345: [
        function (e, t, r) {
          ...
          t.exports = function (t, r, e, n) {
            ...
            function k(e, t) {
              for (i &= E[m], 0 < m ? (i |= e << m) : (i = e), m += l; 8 <= m; )
                v(255 & i, t), (i >>= 8), (m -= 8);
              if (
                ((f < y || b) &&
                  (b
          ...
          t.exports = function (b, v) {
              ...
              for (n = 0; n < 256; n++)
                (i = w[n]),
                  (o =
                    Math.abs(i[0] - e) +
                    Math.abs(i[1] - t) +
                    Math.abs(i[2] - r)) < u && ((u = o), (f = n)),
                  (s = o - (h[n] >> 12)) < c && ((c = s), (l = n)),
                  (a = p[n] >> 10),
                  (p[n] -= a),
                  (h[n] += a << 10);
            ...
            (this.buildColormap = function () {
              !(function () {
                ...
                (function () {
                  var e,
                    ...
                    l = 2048,
                    h = l >> 6;
                  for (h <= 1 && (h = 0), e = 0; e < h; e++)
                    x[e] = f * ((256 * (h * h - e * e)) / (h * h));
                  t =
                    s < 1509
                      ? ((v = 1), 3)
                      : s % 499 != 0
                  ...
                  for (e = 0; e < u; )
                    if (
                      ...
                      (g = n),
                      (m = i),
                      (w[(d = o)][0] -= (p * (w[d][0] - _)) / 1024),
                      (w[d][1] -= (p * (w[d][1] - g)) / 1024),
                      (w[d][2] -= (p * (w[d][2] - m)) / 1024),
                      0 !== h && j(h, o, r, n, i),
                      s <= (y += t) && (y -= s),
                      0 === c && (c = 1),
                      ++e % c == 0)
              ...
              (this.lookupRGB = function (e, t, r) {
                for (
                  var n, i, o, s = 1e3, a = -1, u = f[t], c = u - 1;
                  u < 256 || 0 <= c;
      ...
      349: [
        ...
        { "./_stream_transform": 351, "core-util-is": 342, inherits: 356 },
      ],
      350: [
        function (d, e, t) {
          (function (_) {
            ...
            function t(e, t) {
              ...
              (this.highWaterMark = n || 0 === n ? n : i),
                ...
                (this.encoding = null),
                e.encoding &&
                  (o || (o = d("string_decoder/").StringDecoder),
            ...
            function n(e, t, r, n, i) {
              var o,
                ...
                u = (function (e, t) {
                  ...
                  f.isBuffer(t) ||
                    f.isString(t) ||
                    f.isNullOrUndefined(t) ||
                    e.objectMode ||
                    (r = new TypeError("Invalid non-string/buffer chunk"));
                  return r;
                })(t, r);
              if (u) e.emit("error", u);
              else if (f.isNullOrUndefined(r))
                (t.reading = !1),
                  t.ended ||
                    (function (e, t) {
            ...
            (y = y && y.debuglog ? y.debuglog("stream") : function () {}),
              f.inherits(r, s),
            ...
            function c(e, t) {
              ...
              if (0 === i) r = null;
                ...
                (r = o ? n.join("") : h.concat(n, i)), (n.length = 0);
              else {
                if (e < n[0].length)
                  ...
                  for (var a = 0, u = 0, c = n.length; u < c && a < e; u++) {
                    ...
                    o ? (r += f.slice(0, l)) : f.copy(r, a, 0, l),
            ...
            (r.prototype.read = function (e) {
              ...
              var t = this._readableState,
                r = e;
              if (
                ((!f.isNumber(e) || 0 < e) && (t.emittedReadable = !1),
                0 === e &&
                  t.needReadable &&
                ...
                return (
                  ...
                  0 === t.length && t.ended ? p(this) : l(this),
                  null
                );
              ...
              return (
                ...
                (t.ended || t.reading) && y("reading or ended", (i = !1)),
                i &&
                  (y("do read"),
                  (t.reading = !0),
                  (t.sync = !0),
                ...
                i && !t.reading && (e = a(r, t)),
                (n = 0 < e ? c(e, t) : null),
                f.isNull(n) && ((t.needReadable = !0), (e = 0)),
                (t.length -= e),
                0 !== t.length || t.ended || (t.needReadable = !0),
                r !== e && t.ended && 0 === t.length && p(this),
                f.isNull(n) || this.emit("data", n),
                n
              );
            }),
              ...
              (r.prototype.pipe = function (t, e) {
                ...
                (n.pipesCount += 1),
                  y("pipe count=%d opts=%j", n.pipesCount, e);
                var i =
                  (!e || !1 !== e.end) && t !== _.stdout && t !== _.stderr
                    ? s
                    : c;
                function o(e) {
                  y("onunpipe"), e === r && c();
                ...
                n.endEmitted ? _.nextTick(i) : r.once("end", i),
                  t.on("unpipe", o);
                var a,
                  u =
                    ((a = r),
                ...
                function l(e) {
                  y("onerror", e),
                    d(),
                    t.removeListener("error", l),
                    0 === m.listenerCount(t, "error") && t.emit("error", e);
                }
                function h() {
              ...
              (r.prototype.resume = function () {
                ...
                return (
                  e.flowing ||
                    (y("resume"),
                    (e.flowing = !0),
                    e.reading || (y("resume read 0"), this.read(0)),
                    (r = this),
                    (n = e).resumeScheduled ||
                      ((n.resumeScheduled = !0),
                      _.nextTick(function () {
              ...
              (r.prototype.wrap = function (t) {
                ...
                t.on("data", function (e) {
                  ...
                  e && (r.objectMode || e.length)) &&
                    (i.push(e) || ((n = !0), t.pause()));
                }),
                t))
                  f.isFunction(t[e]) &&
                    f.isUndefined(this[e]) &&
                    (this[e] = (function (e) {
                      return function () {
      ...
      351: [
        function (e, t, r) {
          ...
          function i(e, r) {
            (this.afterTransform = function (e, t) {
              return (function (e, t, r) {
                ...
                (n.writechunk = null),
                  (n.writecb = null),
                  s.isNullOrUndefined(r) || e.push(r);
                i && i(t);
          ...
          (s.inherits = e("inherits")),
            ...
            (o.prototype._read = function (e) {
              ...
              s.isNull(t.writechunk) || !t.writecb || t.transforming
                ? (t.needTransform = !0)
                : ((t.transforming = !0),
                  this._transform(
                    t.writechunk,
        ...
        { "./_stream_duplex": 348, "core-util-is": 342, inherits: 356 },
      ],
      352: [
        function (_, e, t) {
          (function (u) {
            ...
            function i(e) {
              ...
              (this._writableState = new n(e, this)),
                (this.writable = !0),
                r.call(this);
            }
            ...
            function c(e, r) {
              if (
                ((r.bufferProcessing = !0), e._writev && 1 < r.buffer.length)
              ) {
                for (var n = [], t = 0; t < r.buffer.length; t++)
                  n.push(r.buffer[t].callback);
                r.pendingcb++,
                  p(e, r, !0, r.length, r.buffer, "", function (e) {
            ...
            function s(e, t) {
              ...
              return (
                r &&
                  (0 === t.pendingcb
                    ? (o(e, t), (t.finished = !0), e.emit("finish"))
                    : o(e, t)),
                r
              );
            }
            l.inherits(i, r),
              ...
              (i.prototype.write = function (e, t, r) {
                var n,
                  ...
                  a = !1;
                return (
                  l.isFunction(t) && ((r = t), (t = null)),
                  l.isBuffer(e) ? (t = "buffer") : t || (t = s.defaultEncoding),
                  l.isFunction(r) || (r = function () {}),
                  s.ended
                    ? ((n = this),
                      (i = r),
                      (o = new Error("write after end")),
                      n.emit("error", o),
                      u.nextTick(function () {
                        i(o);
                      }))
              ...
              (i.prototype.end = function (e, t, r) {
                ...
                l.isFunction(e)
                  ? ((r = e), (t = e = null))
                  : l.isFunction(t) && ((r = t), (t = null)),
                  l.isNullOrUndefined(e) || this.write(e, t),
                  ...
                  n.ending ||
                    ...
                    (function (e, t, r) {
                      (t.ending = !0),
                        s(e, t),
                        r && (t.finished ? u.nextTick(r) : e.once("finish", r));
                      t.ended = !0;
                    })(this, n, r);
              });
      ...
      353: [
        function (t, r, n) {
          (function (e) {
            ((n = r.exports = t("./lib/_stream_readable.js")).Stream =
              t("stream")),
              ((n.Readable = n).Writable = t("./lib/_stream_writable.js")),
              (n.Duplex = t("./lib/_stream_duplex.js")),
              (n.Transform = t("./lib/_stream_transform.js")),
              (n.PassThrough = t("./lib/_stream_passthrough.js")),
              e.browser ||
                "disable" !== e.env.READABLE_STREAM ||
                (r.exports = t("stream"));
      ...
      363: [
        ...
        { "./_stream_transform": 365, "core-util-is": 342, inherits: 356 },
      ],
      364: [
        function (I, C, e) {
          (function (g, e) {
            ...
            var a,
              u = I("./internal/streams/BufferList"),
            ...
            function o(e, t) {
              ...
              (this.highWaterMark =
                ...
                (this.encoding = null),
                e.encoding &&
                  (a || (a = I("string_decoder/").StringDecoder),
                  (this.decoder = new a(e.encoding)),
                  (this.encoding = e.encoding));
            }
            function h(e) {
              if (((s = s || I("./_stream_duplex")), !(this instanceof h)))
                return new h(e);
            ...
            (h.prototype.read = function (e) {
              ...
              (h.prototype.pipe = function (r, e) {
                ...
                i.endEmitted ? m.nextTick(t) : n.once("end", t),
                  r.on("unpipe", o);
                var a,
                  u =
                    ((a = n),
                ...
                function (e, t) {
                  ...
                  if ("data" === e)
                    ...
                    n.endEmitted ||
                      ...
                      (n.emittedReadable = !1),
                      n.reading ? n.length && x(this) : m.nextTick(E, this));
                  }
                  return r;
                }),
              (h.prototype.resume = function () {
                ...
                return (
                  r.flowing ||
                    ...
                    (e = this),
                    (t = r).resumeScheduled ||
                      ((t.resumeScheduled = !0), m.nextTick(T, e, t))),
                  this
                );
              }),
              ...
              (h.prototype.wrap = function (t) {
                ...
                t.on("data", function (e) {
                  ...
                  n.objectMode && null == e) ||
                    ((n.objectMode || (e && e.length)) &&
                      (r.push(e) || ((i = !0), t.pause())));
                }),
                t))
                  void 0 === this[e] &&
                    "function" == typeof t[e] &&
      ...
      365: [
        ...
        { "./_stream_duplex": 362, "core-util-is": 342, inherits: 356 },
      ],
      366: [
        function (j, S, e) {
          (function (e, t, r) {
            ...
            function f(e) {
              if (
                ((a = a || j("./_stream_duplex")),
                !(s.call(f, this) || this instanceof a))
              )
                return new f(e);
              ...
              if (e._writev && r && r.next) {
                ...
                for (; r; ) {
                  var u = r.chunk,
                    ...
                    f = r.callback;
                  if (
                    (w(e, t, !1, t.objectMode ? 1 : u.length, u, c, f),
                    (r = r.next),
            ...
            n.inherits(f, o),
                ...
                ? ((s = Function.prototype[Symbol.hasInstance]),
                  Object.defineProperty(f, Symbol.hasInstance, {
                    value: function (e) {
                      return (
                        !!s.call(this, e) ||
                        (this === f && e && e._writableState instanceof c)
                      );
                    },
                  }))
                : (s = function (e) {
              ...
              (f.prototype.write = function (e, t, r) {
                var n,
                  ...
                  _ = !1,
                  g =
                    !d.objectMode && ((n = e), y.isBuffer(n) || n instanceof b);
                return (
                  g && !y.isBuffer(e) && ((i = e), (e = y.from(i))),
                  ...
                  d.ended
                    ...
                    : (g ||
                        ...
                        f && (o.emit("error", f), m.nextTick(u, f), (c = !1)),
                        c)) &&
                      (d.pendingcb++,
          ...
          (function (e) {
            !(function (e) {
              ...
              if (a) s && (P.exports = a);
                ...
                (x.prototype = y.constructor = j),
                  (j.constructor = x),
                  (j[o] = x.displayName = "GeneratorFunction"),
                  ...
                  (R.prototype = {
                    ...
                    finish: function (e) {
                      for (var t = this.tryEntries.length - 1; 0 <= t; --t) {
                        ...
                        if (r.finallyLoc === e)
                          return (
                            this.complete(r.completion, r.afterLoc), O(r), _
                          );
                      }
                    },
                    catch: function (e) {
              ...
              function b(e, t, r, n) {
                var o,
                  ...
                  a,
                  u,
                  i = t && t.prototype instanceof w ? t : w,
                  ...
                  (c._invoke =
                    ...
                    function (e, t) {
                      ...
                      for (a.method = e, a.arg = t; ; ) {
                        ...
                        "throw" === i.type &&
                          ((u = d), (a.method = "throw"), (a.arg = i.arg));
                      }
                    })),
                  c
                );
              ...
              function k(a) {
                function u(e, t, r, n) {
                  ...
                  if ("throw" !== i.type) {
                    var o = i.arg,
                      s = o.value;
                    return s && "object" === _typeof2(s) && c.call(s, "__await")
                ...
                var t;
                "object" === _typeof2(e.process) &&
                  e.process.domain &&
                  (u = e.process.domain.bind(u)),
      ...
      378: [
        ...
        { "process/browser.js": 360, timers: 378 },
      ],
      379: [
        function (e, t, r) {
          (function (r) {
      ...
      381: [
        ...
        { "./support/isBuffer": 380, _process: 360, dup: 13, inherits: 356 },
      ],
      382: [
        function (e, t, r) {
          ...
          var h = (function () {
            function t(e) {
              if (
                ...
                l(this, "config", {}),
                l(this, "frames", []),
                l(this, "recordRoutine", null),
                l(this, "oriDensity", 1),
                (this.settings = Object.assign(this.settings, e)),
                (this.settings.canvas =
                  document.getElementById("".concat(this.settings.canvas)) ||
                  window.canvas),
                !this.settings.canvas)
              )
                throw (0, o.default)("cannot find such canvas");
              (this.settings.width < 0 ||
                this.settings.width > this.settings.canvas.width) &&
                (this.settings.width = this.settings.canvas.width),
                (this.settings.height < 0 ||
                  this.settings.height > this.settings.canvas.height) &&
                  (this.settings.height = this.settings.canvas.height),
                30 < this.settings.framerate && (this.settings.framerate = 30),
                (this.settings.context = this.settings.webgl
                  ? this.settings.canvas.getContext("webgl")
                  : this.settings.canvas.getContext("2d"));
            }
            var e, r;
            return (
              f(t, [
                {
                  ...
                  get: function () {
                    return (
                      !!this.recordRoutine && 1 === this.recordRoutine.state
                    );
                  },
                },
                {
                  ...
                  get: function () {
                    return Math.max(
                      parseInt(1e3 / this.settings.framerate, 10),
                      30
                    );
                  },
                },
              ...
              f(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    if (this.isRecording)
                      throw (0, o.default)(
                        "cannot add frame when recording has started."
                      );
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    if (!this.settings.context)
                      throw (0, o.default)("canvas context does not exist");
                    var r = -1;
                    e.frame && 1 <= e.frame && (r = parseInt(e.frame, 10));
                    var n = -1;
                    e.milliSecond && 1 <= e.milliSecond
                      ? (n = parseInt(e.milliSecond, 10))
                      : e.second && 0.001 <= e.second
                      ? (n = parseInt(1e3 * e.second, 10))
                      : e.minute &&
                        0.001 <= e.minute &&
                        (n = parseInt(1e3 * e.second * 60, 10)),
                      (this.frames = []);
                    var i = this;
                    return (
                      (this.recordRoutine = s.Routine.Routine(
                        a(
                          regeneratorRuntime.mark(function e() {
                            return regeneratorRuntime.wrap(
                              function (e) {
                                for (;;)
                                  switch ((e.prev = e.next)) {
                                    case 0:
                                      0 < r && this.tick > r
                                        ? (this.terminate(), t && t.call(i))
                                        : 0 < n &&
                                          this.lasts > n &&
                                          (this.terminate(), t && t.call(i)),
                                        (r <= 0 || r > i.frames.length) &&
                                          (null,
                                          i._addFrame(),
                                          i.frames.push(null));
                                    case 2:
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    if (this.settings.webgl) {
                      ...
                      o = this.settings.context.getImageData(t, r, n, i).data;
                    this.frames.push(o);
                  },
                },
                {
                                  ...
                                  return (
                                    (t =
                                      0 < n.length && void 0 !== n[0]
                                        ...
                                        : "default.gif"),
                                    console.log(
                                      "%c Gif download strats, your browser may lock up for sometime!",
        ...
        { "./Error.js": 383, "./Gif.js": 384, "@nhibiki/js-routine": 6 },
      ],
      383: [
        function (e, t, r) {
          function n(e) {
          ...
          var p = (function (e) {
            function n() {
              ...
              return (
                i(this, n),
                ((e = a(this, h(n).call(this, t))).msg = t),
                (e.code = r),
                e
              );
            }
          ...
          var d = (function () {
            function o(e) {
              ...
              if (
                ...
                p(this, "_isloading", !1),
                p(this, "_frames", null),
                p(this, "_gifConfig", { repeat: !0, delay: [] }),
                ...
                p(this, "__currentController", null),
                t && "object" !== a(t))
              )
                throw new s.default("Config can only be an object.");
              this._gifConfig = Object.assign(this._gifConfig, t);
              var r = (t || {}).onPrepare || null;
              if (r && "function" != typeof r)
                throw new s.default("onPrepare can only be a function.");
              if ("string" == typeof e && e.length) this.__loadGif(e);
              else if (this.__isList(e) && this.__checkFrames(e))
                this.__loadGifFromList(e);
              else {
                if (!this.__isList(e))
                  throw new s.default("Wrong type of sourceGif.");
            ...
            return (
              f(o, [
                {
                  ...
                  value: function (e, t) {
                    if (
                      ((e = parseInt(e)),
                      Number.isNaN(e) || e < 0 || e >= this._frames.length)
                    )
                      throw new s.default("The index is invalid");
                    var r = parseInt(t);
                    return (
                      (!r || r < 10) && (r = this._gifConfig.delay[e]),
                      (this._gifConfig.delay[e] = r)
                    );
                  },
                },
                {
                ...
                },
                {
                  ...
                  set: function (e) {
                    if (!("number" == typeof e && 0 <= e))
                      throw new s.default("Wrong value for height");
                ...
                },
                {
                  ...
                  set: function (e) {
                    if (!("number" == typeof e && 0 <= e))
                      throw new s.default("Wrong value for width");
                  ...
                  set: function (e) {
                    if ("number" == typeof e)
                      return e < 10
                        ...
                        : (this._gifConfig.delay = Array(
                            this._frames.length
                          ).fill(e));
                    if (!this.__isList(e))
                      throw new s.default("Cannot pass in a non-array.");
              ...
              f(o, [
                          ...
                          function (e) {
                            for (;;)
                              switch ((e.prev = e.next)) {
                                case 0:
                                  (t =
                                    0 < l.length && void 0 !== l[0]
                                      ? l[0]
                                      : "default.gif"),
                                    (r =
                                      1 < l.length && void 0 !== l[1]
                                        ? l[1]
                                        : {}),
                                    (n = []),
                                    (i = new h.default(
                                    ...
                                    console.log(
                                      "%c The framerate you set is ".concat(
                                        r.framerate,
                                        "."
                                      ),
                                      "background: #222; color:  #bada55"
                                    ),
                                    this.frames.forEach(function (e, t) {
                                      ((100 * t) / f.frames.length) % 10 == 0 &&
                                        console.log(
                                          "%c "
                                            .concat(
                                              t,
                                    ...
                                    i.finish(),
                                    console.log(
                                      "%c Frames are all dumped, download will start soon.",
                                      "background: #222; color: #bada55"
                                    ),
                                    (s = n.reduce(function (e, t) {
                                      return f.__appendBuffer(e, t);
                                    }, new ArrayBuffer(0))),
                                    (a = new Blob([s], { type: "image/gif" })),
                                    ((u = document.createElement("a")).href =
                ...
                },
                {
                  key: "setFrame",
                  value: function (e, t) {
                    if (e < 0 || e >= this.frames.length)
                      throw new s.default("Wrong value of index");
                    if (!(t instanceof p5.Image))
                      throw new s.default(
                        "Wrong frame type, it should be p5.Image"
                      );
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    ...
                    if (null != r) {
                      if ("function" != typeof r)
                        throw new s.default("Iterator should be a function");
                      r.call(this._frames);
                    } else
                      for (
                        var n = t.reverse(), i = 0;
                        i < this.framesReversed.length;
                        i++
                      )
                        e <= i && 0 !== n.length && (this._frames[i] = n.pop());
                    return this;
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    if (
                      ...
                      throw new s.default("Wrong end, start value");
                    if (t < e && 0 < r)
                      throw new s.default(
                        "end should bigger than start, if step is positive"
                      );
                    ...
                    var e =
                      ...
                      t =
                        1 < arguments.length && void 0 !== arguments[1]
                          ...
                          : 0;
                    if (!this._frames)
                      throw new s.default("should put frames first");
                            ...
                            for (;;)
                              switch ((e.prev = e.next)) {
                                ...
                                case 4:
                                  (r = e.sent),
                                    (this._src = t),
                                    (n = this.__decodeGif(r)),
                                    (this._frames = this.__pixel2Iamge(n)),
                                    (this._isloading = !1),
                                    this._gifConfig.onPrepare &&
                                      i.Routine.Task(
                                        this._gifConfig.onPrepare,
                                        this
                                      )(),
                  ...
                  value: function (e) {
                    return new Promise(function (t, r) {
                      ...
                      (n.responseType = "arraybuffer"),
                        (n.onload = function (e) {
                          200 <= e.target.status && e.target.status < 300
                            ? t(n.response)
                            : r(
                                new s.default(
                                  "Fetch from internet failure.",
                                  e.target.status
                                )
                              );
                        }),
                ...
                },
                {
                  ...
                  value: function (e) {
                    (this._frames = Array.from(e)),
                      (this._src = null),
                      (this._isloading = !1),
                      (this.delay = 100),
                      this._gifConfig.onPrepare &&
                        i.Routine.Task(this._gifConfig.onPrepare, this)();
                  },
                },
                {
                  key: "__checkFrames",
                  value: function (e) {
                    if (!e || !e.forEach)
                      return (
                        s.default.throw(
                          "Cannot construct P5GIF from non-array object."
                        ),
                        !1
                      );
                    var t = !0,
                ...
                },
                {
                  ...
                  value: function () {
                    if (
                      ...
                      throw new s.default("Gif has not been prepared yet.", 1);
                    return !0;
                  },
                },
                {
                  ...
                  value: function (n) {
                    this[
                      ...
                      if (
                        !this.frames ||
                        "function" != typeof this.frames[0][n]
                      )
                        throw new s.default("cannot execute " + n);
                ...
                },
                {
                  ...
                  get: function () {
                    var a = this;
                    if ((this.__checkLoading(), this.__currentController))
                                    ...
                                    case 0:
                                      return (
                                        ...
                                        (a._gifConfig.clear || !0) &&
                                          ...
                                          window.rect(r, n, o, s),
                                          window.pop()),
                                        image(a._frames[u++], r, n, o, s),
                                        u >= a._frames.length &&
                                          ((u = 0),
                                          a._gifConfig.repeat || f.stop()),
                                        e.abrupt(
                                          "return",
                                          (a._gifConfig.delay &&
                                            a._gifConfig.delay[u]) ||
                                            100
                                        )
                                      );
                                    case 7:
                      ...
                      e = function () {
                        var e =
                          0 < arguments.length && void 0 !== arguments[0]
                            ? arguments[0]
                            : null;
                        c && (c = Object.assign(c, e)),
                          (a._gifConfig.repeat = !0),
                          f.start();
                      },
                      t = function () {
                        var e =
              ...
              (r = [
                {
                  ...
                  value: function () {
                    if (
                      ...
                      window.p5 &&
                      window.p5.Image &&
                      "function" == typeof window.p5.Image
                    )
                      return !0;
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    return (
                      ...
                      !!r &&
                        (r.setAttribute("aria-live", !0),
                        r.setAttribute("aria-label", "defaultCanvas0"),
                        !0)
                    );
                  },
                },
      ...
      386: [
        function (e, t, r) {
          ...
          (n.default.GIFEncoder = i.default),
            "undefined" != typeof window && (window.p5Gif = n.default),
            (t.exports = n.default);
        },
        {
